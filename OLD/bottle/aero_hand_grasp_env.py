...
class AeroHandGraspEnvCfg(DirectRLEnvCfg):
    ...
    observation_space = 42         # 16 joint_pos + 16 joint_vel + 3 bottle_pos + 3 bottle_vel + 4 bottle_quat
    state_space = 0
    ...
    # grasp / reset
    # grasp_joint_pos = 0.0            # radians — TUNE against your bottle's actual diameter
    ...
    # reward scales
    rew_scale_bottle_height = 5.0
    rew_scale_bottle_still = -0.1
...
class AeroHandGraspEnv(DirectRLEnv):
    ...
    def _get_observations(self) -> dict:
        ...
        bottle_pos_rel = self.bottle.data.root_pos_w - self.scene.env_origins
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        rew_height = self.cfg.rew_scale_bottle_height * held.float()
    ...
    def _reset_idx(self, env_ids: Sequence[int] | None):
        ...
        # --- Hand: spawn already closed around the bottle ---

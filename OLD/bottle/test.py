...
# #     print(f"  terminated.sum():  {terminated.sum().item()}  (envs that dropped the bottle)")
...
# terminated — bool tensor, shape (num_envs,). True where the bottle dropped past bottle_drop_height_thresh.

...
CREDIT_CARD_USD_PATH = "/home/hao/Documents/aero-hand-open/sim_rl/simulation/mujoco/only_credit_card.usda"

CREDIT_CARD_CFG = RigidObjectCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=CREDIT_CARD_USD_PATH,

...
class AeroHandGraspEnvCfg(DirectRLEnvCfg):
    ...
    observation_space = 42         # 16 joint_pos + 16 joint_vel + 3 mug_pos + 3 mug_vel + 4 mug_quat
    state_space = 0
    ...
    # grasp / reset
    # grasp_joint_pos = 0.0            # radians — TUNE against your mug's actual diameter
    ...
    # note: doesn't work; for testing purposes
    # grasp_joint_pos = {
    ...
    # reward scales
    rew_scale_mug_height = 5.0
    rew_scale_mug_still = -0.1
...
class AeroHandGraspEnv(DirectRLEnv):
    ...
    def _get_observations(self) -> dict:
        ...
        mug_pos_rel = self.mug.data.root_pos_w - self.scene.env_origins
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        rew_height = self.cfg.rew_scale_mug_height * held.float()
    ...
    def _reset_idx(self, env_ids: Sequence[int] | None):
        ...
        # --- Hand: spawn already closed around the mug ---

...
# #     print(f"  terminated.sum():  {terminated.sum().item()}  (envs that dropped the pen)")
...
# terminated — bool tensor, shape (num_envs,). True where the pen dropped past pen_drop_height_thresh.

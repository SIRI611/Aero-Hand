...
class AeroHandGraspEnv(DirectRLEnv):
    ...
    def _get_observations(self) -> dict:
        ...
        if obs.shape[0] > 0:
            ...
            print("card_pos_rel:", [f"{v:.3f}" for v in card_pos_rel[env0].tolist()])
            print("card_lin_vel:", [f"{v:.3f}" for v in card_lin_vel[env0].tolist()])
            print("card_ang_vel:", [f"{v:.3f}" for v in card_ang_vel[env0].tolist()])
            print("card_quat:", [f"{v:.3f}" for v in card_quat[env0].tolist()])
